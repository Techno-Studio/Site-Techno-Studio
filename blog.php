...
<div class="section no-pad-bot" id="index-banner">
    <div class="container">
      <br><br>
      <h3 class="header center green-text">Приветствую Вас на сайте нашей школы</h3>
...
echo "<div class='card '>
             ...
             "<p><a class='waves-effect waves-light btn green' href='fullnews.php?news_id=".$row['news_id']."'>Далее <i class='material-icons right'>arrow_forward</i></a></p></div>",
